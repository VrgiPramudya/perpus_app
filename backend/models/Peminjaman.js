...
const PeminjamanSchema = new mongoose.Schema({
    ...
    id_petugas: { type: mongoose.Schema.Types.ObjectId, ref: 'Petugas', required: true },
    tanggal_pinjam: { type: Date, required: true },
    tanggal_kembali_seharusnya: { type: Date, required: true },
    status_transaksi: { type: String, required: true }
});
